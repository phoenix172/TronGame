...
namespace SimpleSolutionNET.GameEngine
{
    public class TronGame
    {
        ...
        public void PlayTurn()
        {
            ...
            var turnContext = CreateTurnContext(currentPosition, opponentPosition);
            var newPosition = strategy.PlayTurn(turnContext);
        ...
        private TurnContext CreateTurnContext(Position currentPosition, Position opponentPosition) 
            => new TurnContext(State.Board.CloneBoard(),
            NextPlayer, currentPosition, opponentPosition,
            NextPlayer == Settings.FirstPlayer);
